...
--
-- Hôte : localhost:3306
-- Généré le : mer. 17 déc. 2025 à 21:28
...
--
-- Base de données : `projet_suivi_de_stage`
--
...
(11, 'admin', 'admin', NULL, 'admin', '21232f297a57a5a743894a0e4a801fc3', 2, NULL, 0, NULL),
(12, 'prof', 'prof', NULL, 'prof', 'd450c5dbcc10db0749277efc32f15f9f', 1, NULL, 1, NULL),
(13, 'eleve', 'eleve', NULL, 'eleve', 'c16da4ad70df593520193184381b9f21', 0, NULL, 0, NULL);
...
--
ALTER TABLE `utilisateur`
  MODIFY `num` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
